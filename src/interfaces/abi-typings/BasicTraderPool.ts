...
export type ContractContext = EthersContractContextV5<
  BasicTraderPool,
  BasicTraderPoolMethodNames,
  BasicTraderPoolEventsContext,
  BasicTraderPoolEvents
>
...
export type BasicTraderPoolEvents =
  ...
  | "ProposalDivested"
  | "Transfer"
export interface BasicTraderPoolEventsContext {
...
export type BasicTraderPoolMethodNames =
  | "__BasicTraderPool_init"
  | "__TraderPool_init"
  | "allowance"
  | "approve"
  | "balanceOf"
...
export interface __BasicTraderPool_initRequest {
  descriptionURL: string
  trader: string
  privatePool: boolean
...
export interface BasicTraderPool {
  /**
   * Payable: false
   * Constant: false
  ...
  __BasicTraderPool_init(
    name: string,
    symbol: string,
    _poolParameters: __BasicTraderPool_initRequest,
   ...
   * @param minDivestOut Type: uint256[], Indexed: false
   * @param minProposalOut Type: uint256, Indexed: false
  ...
  createProposal(
    ...
    minDivestOut: BigNumberish[],
    minProposalOut: BigNumberish,
    optionalPath: string[],
    overrides?: ContractTransactionOverrides
  ): Promise<ContractTransaction>
  /**
   ...
   * Type: function
   * @param proposalId Type: uint256, Indexed: false
   * @param lp2Amount Type: uint256, Indexed: false
   * @param minPositionsOut Type: uint256[], Indexed: false
   * @param minProposalOut Type: uint256, Indexed: false
   */
  reinvestProposal(
    proposalId: BigNumberish,
    lp2Amount: BigNumberish,
    minPositionsOut: BigNumberish[],
    minProposalOut: BigNumberish,
    overrides?: ContractTransactionOverrides
  ): Promise<ContractTransaction>
