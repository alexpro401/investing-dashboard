...
export const TIMEFRAME_AGREGATION_CODES: IAggregationCodes = {
  [TIMEFRAMES["D"]]: [AGREGATION_CODES["5min"], AGREGATION_CODES["15min"]],
  [TIMEFRAMES["W"]]: [AGREGATION_CODES["1h"], AGREGATION_CODES["2h"]],
  [TIMEFRAMES["M"]]: [AGREGATION_CODES["4h"], AGREGATION_CODES["6h"]],
  [TIMEFRAMES["3M"]]: [
  ...
  [TIMEFRAMES["ALL"]]: [AGREGATION_CODES["24h"], AGREGATION_CODES["1m"]],
}
...
export const TIMEFRAME_LIMIT_CODE = {
  ...
  [TIMEFRAMES["M"]]: 124, // (24h * 31d) / TIMEFRAME_MIN_CODE["M"]
  [TIMEFRAMES["3M"]]: 93,
  [TIMEFRAMES["6M"]]: 124,
  [TIMEFRAMES["1Y"]]: 124,
  [TIMEFRAMES["ALL"]]: 1000,
