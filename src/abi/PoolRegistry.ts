export default [
  ...
  {
    inputs: [],
    name: "DISTRIBUTION_PROPOSAL_NAME",
    outputs: [{ internalType: "string", name: "", type: "string" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "__OwnablePoolContractsRegistry_init",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "address", name: "potentialPool", type: "address" },
    ],
    name: "isBasicPool",
